...
<details><summary>Svelte 4</summary>

```svelte frame="code" title="Coordinates.svelte"
<script>
...
```svelte frame="code" title="App.svelte"
<script>
...
```jsx frame="code" title="Coordinates.jsx"
...
```svelte frame="code" title="Coordinates.svelte" {6, 8}
<script>
  import { onMount } from "svelte";
...
Svelte repo linking this article.

lmk here and in the comments what you think, cuz that's enough yapping from me.
And make sure to [connect](/connect) with me on my socials and stuff if you
want!
